...
{
    TaskDetailCellType              = 0,
    TaskDescriptionCellType         = 1,
    CollectionCellType              = 2,
    SubtaskInfoCellType             = 3,
    AttachmentsCellType             = 4,
    CommentsCellType                = 5,
    LogWithActionCellType           = 6,
    LogWithDetailCellType           = 7,
    LogCellType                     = 8,
    FilterSubtasksCellType          = 9,
    FilterAttachmentsCellType       = 10,
    AddCommentCellType              = 11,
    LogDefaultCellType              = 12,
    LogWithUpdatedStringValuesType  = 13,
    LogWithChangedStatusCellType    = 14,
    LogWithAssigneeCellType         = 15,
    LogWithTaskTypeCellType         = 16,
    LogWithRenamedCellType          = 17,
    LogWithMarkCellType             = 18,
    LogWithErrorCellType            = 19,
    LogWithAttachmentCellType       = 20,
    LogWithCommentCellType          = 21,
};
